...
public class ParquetToHiveTableConfig {
    ...
    private ParquetToHiveTableConfig(String pathFrom, String baseTo, String tableTo, List<String> partitions) {
    ...
    public static ParquetToHiveTableConfig getConfig(String[] args) throws Exception {
        if(args.length < 3)
        ...
        return new ParquetToHiveTableConfig(pathFrom, baseTo, tableTo, partitions);
    }
