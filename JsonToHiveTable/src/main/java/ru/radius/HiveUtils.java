...
public class HiveUtils {
    ...
    public static void createTransactionalHiveTable(List<String> listColumns, JsonToHiveTableConfig config) throws Exception {
    ...
    public static void insetToHiveTable(JsonToHiveTableConfig config) throws Exception {
        SparkSession spark = JsonToHiveTable.spark;
        ...
        String sparkScript = String.format("CREATE TEMPORARY VIEW %s USING json OPTIONS(path '%s')",tmpTableName, config.getPathFrom());
